...
Save time by quickly and painlessly create dummy test content for your site.
...
1. Upload `test-content-suite` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the `Plugins` menu in WordPress
3. Go to Tools->Test Content to see and edit your options

== Screenshots ==

1. Test Content admin panel
